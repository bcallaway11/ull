...
<span style="display: none;">[@chaisemartin-dhaultfoeuille-vazquez-2024-AEAPP]</span>
...
* **Haddad, Huber, and Zhang (2024)** study DiD with time-varying continuous treatments and multiple periods.

* Their approach compares two nonzero treatment doses and allows for covariate adjustment and past treatment histories.

* They use kernel-based estimators combined with double/debiased machine learning, allowing flexible, data-adaptive adjustment for covariates.

* Their framework is complementary to the two-period panel-data setting considered here. [@haddad-huber-zhang-2024]
